...
<head>
    ...
    <title>Tambah Jenis Sampah - Green Saving</title>
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="mb-6">
            <nav class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span>/</span>
                <span class="text-green-600 font-semibold">Tambah Data</span>
            </nav>
        </div>
        ...
        <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl shadow-lg p-6 mb-6">
            <div class="flex items-center gap-4">
                ...
                <div class="text-white">
                    <h2 class="font-bold text-2xl">Tambah Jenis Sampah</h2>
                    <p class="text-green-50 text-sm mt-1">Tambahkan jenis sampah baru ke dalam sistem</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <form action="{{ route('admin.waste-types.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    @enderror
                    <p class="text-gray-500 text-sm mt-1">
                        <i class="bi bi-info-circle"></i> Format: JPG, JPEG, PNG, GIF (Max: 2MB)
                    </p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <button 
                        type="submit"
                        class="flex-1 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2"
                    >
