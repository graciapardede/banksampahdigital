...
<head>
    ...
    <title>Detail Penukaran - Laporan Cabang</title>
    ...
    <main class="max-w-7xl mx-auto px-4 py-8">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 flex items-center">
                        <i class="bi bi-file-earmark-text mr-3 text-purple-600"></i>
        ...
        <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-6 mb-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-purple-100 text-sm mb-1">Total Transaksi Penukaran</p>
                    <h3 class="text-4xl font-bold">{{ $redemptions->total() }}</h3>
                </div>
                ...
                <table class="w-full">
                    <thead class="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-bold">Barang Ditukar</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-purple-50 transition-colors">
                            <td class="px-6 py-4 text-sm text-gray-700">
                                {{ ($redemptions->currentPage() - 1) * $redemptions->perPage() + $index + 1 }}
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-1">
                                    ...
                                    <div class="flex items-center gap-2 text-xs">
                                        <span class="px-2 py-1 bg-purple-100 text-purple-700 rounded-lg font-medium">
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg font-semibold text-xs">
                                    Selesai
                                </span>
                                @endif
                            </td>
                            <td class="px-6 py-4 text-right">
                                <span class="px-3 py-1 bg-purple-100 text-purple-700 rounded-lg font-bold text-sm">
                                    {{ number_format($redemption->total_points) }} poin
                                </span>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p class="text-lg">Tidak ada data penukaran pada periode ini</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
                    ...
                    <tfoot class="bg-gray-50 border-t-2 border-gray-300">
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-right font-bold text-gray-800">TOTAL POIN DITUKAR:</td>
                            <td class="px-6 py-4 text-right font-bold text-purple-700 text-lg">
                                {{ number_format($redemptions->sum(function($r) { return $r->total_points; })) }} poin
                            </td>
                        </tr>
                    </tfoot>
                    @endif
