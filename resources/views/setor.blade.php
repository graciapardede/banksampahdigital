        ...
        <div class="bg-green-100 px-4 py-4">
            <div class="max-w-6xl mx-auto flex justify-center">
                <div class="flex flex-wrap gap-3 justify-center">
                    ...
                    <a href="/setor" class="bg-green-500 text-white px-4 py-3 rounded-2xl text-xs lg:text-sm font-semibold shadow-md flex items-center justify-center gap-2 cursor-default whitespace-nowrap">
